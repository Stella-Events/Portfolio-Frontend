            ...
            <div className="flex flex-row ml-10 gap-x-3">
                ...
                <div className="flex flex-col ml-10 mt-5 gap-y-10 border-white border-2 rounded-xl">
                    ...
                    <div className="h-[320px] w-96 bg-purple-600/0 rounded-xl flex justify-center items-center flex-col gap-y-3">
                        <div className=" text-2xl font-bold text-center items-center text-orange-600">{projectName}</div>
                        ...
                        <div className="flex flex-row">
                            <div className="text-white text-1xl font-bold text-start italic pl-3 flex flex-row gap-x-2"><MapPin className="size-6 text-orange-600 pt-1" />{location}</div>
