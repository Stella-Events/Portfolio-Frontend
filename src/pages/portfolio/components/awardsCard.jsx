...
const AwardsCard = ({ image, awards, description, date, nameOfInstitution}) => {
    ...
    return (
        ...
        <div className="h-60 w-[450px] bg-purple-950/20 place-content-center 
            ...
            <div className="flex flex-row justify-center relative gap-5">
                <div className="w-1/2">
                    <img src={image} alt="" className="h-50 w-full border border-[#8e44ad]" />
                ...
                <div className="flex flex-col gap-y-3 justify-evenly">
                    <div className="text-white text-1xl font-bold flex flex-row text-start gap-x-4"><Trophy className="text-[#8e44ad]"/>{awards}</div>
                    ...
                    <div className="text-white flex flex-row text-start gap-x-4"><Landmark className="text-[#8e44ad] size-[40px]"/>{nameOfInstitution}</div>
